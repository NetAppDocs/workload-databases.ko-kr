...
* *자격 증명 및 권한*: Workload Factory에서 샌드박스 복제본을 생성하려면 link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWS 계정 자격 증명 및 _작업 및 복구_ 권한"^]이(가) 있어야 합니다.
+
