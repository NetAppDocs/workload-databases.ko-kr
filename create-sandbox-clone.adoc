...
* *자격 증명 및 권한*: 다음이 필요합니다. link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWS 계정 자격 증명 및 _보기, 계획 및 분석_ 권한"^] Workload Factory에서 샌드박스 복제본을 생성합니다.
+
