...
_QUICK CREATE_OR_Advanced CREATE_DEPLOCATION 모드를 사용하여 Workload Factory에서 이 작업을 _AUTOMATE_MODE 권한으로 완료할 수 있습니다. 코드상자에서 사용할 수 있는 REST API, CloudFormation 및 Terraform 도구를 사용할 수도 있습니다. link:https://docs.netapp.com/us-en/workload-setup-admin/use-codebox.html#how-to-use-codebox["자동화를 위해 Codebox를 사용하는 방법을 알아보십시오"^]..
