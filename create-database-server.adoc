...
+
--
또는 CodeBox를 사용하여 빈 템플릿을 복사하거나 완료된 템플릿을 생성하여 REST API, AWS CLI, AWS CloudFormation을 사용하여 워크로드 공장 외부에 데이터베이스를 구축할 수 있습니다. link:https://docs.netapp.com/us-en/workload-setup-admin/codebox-automation.html["Codebox 자동화에 대해 자세히 알아보십시오"^]..
