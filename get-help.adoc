...
summary: 'NetApp은 워크로드 팩토리 및 클라우드 서비스를 다양한 방식으로 지원합니다. 기술 자료(KB) 기사 및 커뮤니티 포럼과 같은 광범위한 무료 셀프 지원 옵션이 24x7 제공됩니다. 지원 등록에는 웹 티켓팅을 통한 원격 기술 지원이 포함됩니다.' 
---
= 데이터베이스용 BlueXP  워크로드 팩토리에 대한 지원을 받으십시오
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
